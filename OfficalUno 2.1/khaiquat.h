...
SDL_Texture* tickImg = loadTexture("tickkk.png");
SDL_Texture* avatar = loadTexture("unknown.jfif");
SDL_Texture* emptySquare = loadTexture("nentrang.png");
SDL_Texture* whiteFrame = loadTexture("nentrang.png");
SDL_Texture* secretCards = loadTexture("cards.png");
SDL_Texture* endGame = loadTexture("endscreen.jpg");
SDL_Texture* mui1 = loadTexture("reverse effect/mui1.png");
SDL_Texture* mui2 = loadTexture("reverse effect/mui2.png");
SDL_Texture* mui3 = loadTexture("reverse effect/mui3.png");
SDL_Texture* mui4 = loadTexture("reverse effect/mui4.png");
SDL_Texture* nope = loadTexture("nope.png");
SDL_Texture* arrow = loadTexture("down.png");
SDL_Texture* secretCard = loadTexture("secret.png");
SDL_Texture* pauseButton = loadTexture("pause.png");
SDL_Texture* resume = loadTexture("resume.png");
SDL_Texture* returnMenu = loadTexture("returnmenu.png");

TTF_Font* fontNum = loadFont("arcadeclassic.ttf", 30);
TTF_Font* fontTitle = loadFont("arcadeclassic.ttf", 40);
TTF_Font* fontCum1 = loadFont("Arial.ttf", 50);
TTF_Font* fontCum2 = loadFont("arcadeclassic.ttf", 45);
TTF_Font* bigFont = loadFont("arcadeclassic.ttf", 60);
