...
SDL_Texture* blackTriangle = loadTexture("assests/images/triangle.png");
SDL_Texture* blackTriangle1 = loadTexture("assests/images/triangle1.png");
SDL_Texture* blackTriangle2 = loadTexture("assests/images/triangle2.png");
...
Mix_Chunk *matchClick = loadSound("assests/mixers/matchSound.wav");
Mix_Chunk *drawClick = loadSound("assests/mixers/drawSound.wav");
Mix_Chunk *skipWav = loadSound("assests/mixers/skipSound.wav");
Mix_Chunk *reverseWav = loadSound("assests/mixers/reverseSound.wav");
Mix_Chunk *plusingSound = loadSound("assests/mixers/congdon.wav");
Mix_Chunk *bePlusedSound = loadSound("assests/mixers/bicongdon.wav");
Mix_Chunk *winningSound = loadSound("assests/mixers/winning.wav");
Mix_Chunk *losingSound = loadSound("assests/mixers/losing.wav");
